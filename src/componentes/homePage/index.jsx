...
const PageNuKenzie = ({listTransaction, addValues, setFilter, removeCard, values, setStart}) => {
    ...
    return (
        <div className="container">
            ...
            <div className="content_page">
                ...
                <ListValuesInserted listTransaction={listTransaction} setFilter={setFilter} removeCard={removeCard}/>
            </div>
        </div>
    )
}
